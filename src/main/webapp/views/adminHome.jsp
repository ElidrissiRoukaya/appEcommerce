...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item active"><a class="nav-link" href="/admin/homePage">Home Page</a></li>
    ...
    <div class="jumbotron text-center">
        <h1 class="display-4">Welcome Back, Admin &#128075</h1>
        <hr>
        <p>Take control of your data using this Admin Panel</p>
    </div>
    <div class="container-fluid">
            ...
            <div class="col-sm-3 pt-4">
                <div class="card border border-info">
                    <div class="card-body text-center">
                       ...
                       <img src="/img/category.png" width="100px" height="100px">
            ...
            <div class="col-sm-3 pt-4">
                <div class="card">
                    <div class="card-body text-center">
                       ...
                       <img src="/img/product.png" width="100px" height="100px">
            ...
            <div class="col-sm-3 pt-4">
                <div class="card">
                    <div class="card-body text-center">
                      ...
                      <img src="/img/costmers.jpg" width="100px" height="100px">
